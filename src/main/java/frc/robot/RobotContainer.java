...
public class RobotContainer {
        ...
        private void configureButtonBindings() {
                ...
                operatorController.a().whileTrue(new TransferCommands().setVoltage(transfer, 6.0));
                operatorController.x().whileTrue(new TransferCommands().setVoltage(transfer, -6.0));
